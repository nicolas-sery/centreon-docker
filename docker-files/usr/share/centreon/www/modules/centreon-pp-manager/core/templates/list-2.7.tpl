...
<div class="pluginpack-block">
  <h2>{$labels.title_page}</h2>
    {if !$hasLicense}
        {if $isAuth}
            <a href="http://support.centreon.com" id='helpdesk' name='helpdesk' class="btc ppm-orange-button toHideInFullscreen">{t}Online Helpdesk{/t}</a>
        {else}
            <a href="http://www.centreon.com/imp-subscription" id='imp_subscription_button' name='imp_subscription_button' class="btc ppm-orange-button toHideInFullscreen">{t}Subscription{/t}</a>
        {/if}
    {/if}
