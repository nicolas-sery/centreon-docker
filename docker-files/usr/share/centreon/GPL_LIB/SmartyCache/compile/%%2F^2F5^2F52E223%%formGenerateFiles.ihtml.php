<?php /* Smarty version 2.6.18, created on 2017-05-24 10:13:05
         compiled from formGenerateFiles.ihtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', 'formGenerateFiles.ihtml', 8, false),)), $this); ?>
...
>
	 ...
	 <table class="formTable table">
		...
		<tr class="list_two"><td class="FormRowField" colspan="2"><img class="helpTooltip" name="gen">&nbsp;<?php echo $this->_tpl_vars['form']['gen']['html']; ?>
&nbsp;<?php echo $this->_tpl_vars['form']['gen']['label']; ?>
</td></tr>
		<tr class="list_one"><td class="FormRowField" colspan="2"><img class="helpTooltip" name="debug">&nbsp;<?php echo $this->_tpl_vars['form']['debug']['html']; ?>
