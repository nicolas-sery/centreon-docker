<?php /* Smarty version 2.6.18, created on 2017-05-24 11:27:07
         compiled from formCentreonBroker.ihtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'formCentreonBroker.ihtml', 9, false),array('modifier', 'capitalize', 'formCentreonBroker.ihtml', 9, false),)), $this); ?>
...
&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['form']['reset']['html']; ?>
    ...
    <div id='tab1' class='tab'>
        <table class="formTable table">
            ...
            <tr class="list_two"><td class="FormRowField"><?php echo $this->_tpl_vars['form']['cache_directory']['label']; ?>
</td><td class="FormRowValue"><?php echo $this->_tpl_vars['form']['cache_directory']['html']; ?>
</td></tr>
			<tr class="list_one"><td class="FormRowField"><?php echo $this->_tpl_vars['form']['activate_watchdog']['label']; ?>
</td><td class="FormRowValue"><?php echo $this->_tpl_vars['form']['activate_watchdog']['html']; ?>
</td></tr>
			<tr class="list_lvl_2">
				<td class="ListColLvl1_name" colspan="2">
					<h4><?php echo $this->_tpl_vars['centreonbroker_watchdog_log']; ?>
</h4>
				</td>
			</tr>
            <tr class="list_two"><td class="FormRowField"><?php echo $this->_tpl_vars['form']['activate']['label']; ?>
            ...
            <tr class="list_two"><td class="FormRowField"><?php echo $this->_tpl_vars['form']['event_queue_max_size']['label']; ?>
</td><td class="FormRowValue"><?php echo $this->_tpl_vars['form']['event_queue_max_size']['html']; ?>
</td></tr>
            <tr class="list_one"><td class="FormRowField"><?php echo $this->_tpl_vars['form']['command_file']['label']; ?>
...
?>
			...
			<tbody class="collapse-wrapper" id="<?php echo $this->_tpl_vars['tab']['id']; ?>
...
function addInfo(type) {
    ...
    tbody.writeAttribute(\'class\', \'collapse-wrapper\');
