...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'blockConfig.ihtml', 4, false),array('modifier', 'is_array', 'blockConfig.ihtml', 25, false),array('block', 't', 'blockConfig.ihtml', 26, false),)), $this); ?>
<tr class="list_lvl_1 close">
  <td class="ListColLvl1_name">
      <span class="expand"></span>
      <?php echo ((is_array($_tmp=$this->_tpl_vars['tagBlock'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
 ...
 - <?php echo $this->_tpl_vars['formBlock']['header']['typeName']; ?>
  ...
  <td class="ListColLvl1_name" style="text-align: right;">
      <a href="javascript:deleteRow('<?php echo $this->_tpl_vars['tagBlock']; ?>
', <?php echo $this->_tpl_vars['posBlock']; ?>
);">
