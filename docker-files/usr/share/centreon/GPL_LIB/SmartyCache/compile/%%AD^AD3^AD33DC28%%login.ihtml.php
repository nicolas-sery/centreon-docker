<?php /* Smarty version 2.6.18, created on 2017-05-24 10:20:13
...
<html>
    ...
    <body OnLoad="document.login.useralias.focus();">
        <form action="./index.php" method="post" name="login" style="height: 100%;">
            ...
            <input type='hidden' value='<?php echo $this->_tpl_vars['redirect']; ?>
' name='redirect'>
            <?php endif; ?>
...
?>
                ...
                <div class="logintab">
                    <table id="logintab1" style="text-align:center;" align="center">
                       <tr>
                            <td align='right'><?php echo $this->_tpl_vars['form']['useralias']['label']; ?>
</td>
                            <td><?php echo $this->_tpl_vars['form']['useralias']['html']; ?>
</td>
                        </tr>
                        <tr>
                            <td align='right'><?php echo $this->_tpl_vars['form']['password']['label']; ?>
</td>
                            <td><?php echo $this->_tpl_vars['form']['password']['html']; ?>
</td>
                        </tr>
                        <tr>
                            <td colspan="2" align='center'><?php echo $this->_tpl_vars['form']['submitLogin']['html']; ?>
</td>
                        </tr>
                    </table>
                </div>
                <div class="LoginInvitVersion">
                    <span id="LoginInvitcpy">
                        &copy; <a href="mailto:contact@centreon.com">Centreon</a> 2005 - 2017
                    </span>
                    <br>
                    <span>
