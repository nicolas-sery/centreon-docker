<?php /* Smarty version 2.6.18, created on 2017-05-24 11:26:19
         compiled from listNagios.ihtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', 'listNagios.ihtml', 7, false),)), $this); ?>
<script type="text/javascript" src="./include/common/javascript/tool.js"></script>
<?php if ($this->_tpl_vars['msg_interval']): ?><center><span class='msg'><?php echo $this->_tpl_vars['msg_interval']; ?>
...
<form name='form' method='POST'>
    ...
    <tbody>
      ...
      <tr>
        <td><h4><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Monitoring engine config<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></h4></td>
      </tr>
      <tr>
        <td><input type="text" name="searchN" value="<?php echo $this->_tpl_vars['searchN']; ?>
"></td>
...
" type="hidden">
	...
	<table class="ListTable">
		<tr class="ListHeader">
			...
			<td class="ListColHeaderLeft"><?php echo $this->_tpl_vars['headerMenu_instance']; ?>
</td>
...
"><?php echo $this->_tpl_vars['elemArr'][$this->_sections['elem']['index']]['RowMenu_desc']; ?>
			...
			<td class="ListColLeft"><?php echo $this->_tpl_vars['elemArr'][$this->_sections['elem']['index']]['RowMenu_instance']; ?>
</td>
