<?php /* Smarty version 2.6.18, created on 2017-05-24 11:26:04
         compiled from listServers.ihtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', 'listServers.ihtml', 19, false),)), $this); ?>
<?php echo '
...
" class="btc bt_success"><?php echo $this->_tpl_vars['msg']['addT']; ?>
                ...
                &nbsp;
                <?php endif; ?>
                <?php if ($this->_tpl_vars['is_admin'] == 1 || $this->_tpl_vars['can_generate'] == 1): ?>
...
>
            ...
            <td class="ListColLeft"><?php if ($this->_tpl_vars['mode_access'] == w): ?><a href="<?php echo $this->_tpl_vars['elemArr'][$this->_sections['elem']['index']]['RowMenu_link']; ?>
"><?php endif; ?><?php echo $this->_tpl_vars['elemArr'][$this->_sections['elem']['index']]['RowMenu_name']; ?>
<?php if ($this->_tpl_vars['mode_access'] == w): ?></a><?php endif; ?></td>
            <td class="ListColCenter"><?php if ($this->_tpl_vars['mode_access'] == w): ?><a href="<?php echo $this->_tpl_vars['elemArr'][$this->_sections['elem']['index']]['RowMenu_link']; ?>
"><?php endif; ?><?php echo $this->_tpl_vars['elemArr'][$this->_sections['elem']['index']]['RowMenu_ip_address']; ?>
<?php if ($this->_tpl_vars['mode_access'] == w): ?></a><?php endif; ?></td>
            ...
            <td class="ListColCenter">
                <span class="badge <?php if ($this->_tpl_vars['elemArr'][$this->_sections['elem']['index']]['RowMenu_hasChangedFlag'] == 0): ?>service_ok<?php else: ?>service_critical<?php endif; ?>">
