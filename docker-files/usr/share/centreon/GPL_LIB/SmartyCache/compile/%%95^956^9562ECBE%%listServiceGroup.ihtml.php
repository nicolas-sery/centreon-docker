<?php /* Smarty version 2.6.18, created on 2017-05-24 09:54:26
         compiled from listServiceGroup.ihtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 't', 'listServiceGroup.ihtml', 7, false),)), $this); ?>
...
<form name='form' method='POST'>
    <table class="ajaxOption table">
      ...
      <tr>
        <td><input type="text" name="searchSG" value="<?php echo $this->_tpl_vars['searchSG']; ?>
"></td>
...
" type="hidden">
	...
	<table class="ListTable">
		<tr class="ListHeader">
			...
			<td class="ListColHeaderRight"><?php if ($this->_tpl_vars['mode_access'] == 'w'): ?><?php echo $this->_tpl_vars['headerMenu_options']; ?>
...
"><?php echo $this->_tpl_vars['elemArr'][$this->_sections['elem']['index']]['RowMenu_status']; ?>
			...
			<td class="ListColRight"><?php echo $this->_tpl_vars['elemArr'][$this->_sections['elem']['index']]['RowMenu_options']; ?>
</td>
		</tr>
		<?php endfor; endif; ?>
