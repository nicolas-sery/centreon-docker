<?php /* Smarty version 2.6.18, created on 2017-05-24 11:23:27
...
&nbsp;&nbsp;<?php echo $this->_tpl_vars['form']['host_snmp_version']['html']; ?>
 ...
 <?php if ($this->_tpl_vars['o'] == 'mc'): ?> | <?php echo $this->_tpl_vars['form']['mc_mod_nsid']['html']; ?>
<?php endif; ?></td>
			</tr>
            <?php endif; ?>
			<tr class="list_two">
...
$this->_smarty_include(array('smarty_include_tpl_file' => "file:".($this->_tpl_vars['centreon_path'])."/www/include/common/templates/cloneHost.ihtml", 'smarty_include_vars' => array('cloneId' => 'template','cloneSet' => $this->_tpl_vars['cloneSetTemplate'])));
...
unset($_smarty_tpl_vars);
 ?></td>
			...
			<tr class="list_two">
				<td class="FormRowField"><img class="helpTooltip" name="check_command_args"> <?php echo $this->_tpl_vars['form']['command_command_id_arg1']['label']; ?>
</td>
				<td class="FormRowValue">
...
<div id='tab2' class='tab'>
	<table class="formTable table">
        ...
        <tr class="list_one">
			...
			<td class="FormRowValue"><?php echo $this->_tpl_vars['form']['contact_additive_inheritance']['html']; ?>
 <img class="helpTooltip" name="contact_additive_inheritance"></td>
        </tr>		
        <?php endif; ?>
        <?php if ($this->_tpl_vars['o'] == 'mc'): ?>
        <tr class="list_one">
        ...
        <tr class="list_one">
			<td class="FormRowField"></td>
			<td class="FormRowValue"><?php echo $this->_tpl_vars['form']['cg_additive_inheritance']['html']; ?>
 <img class="helpTooltip" name="cg_additive_inheritance"></td>
        </tr>		
		<?php endif; ?>
		<tr class="list_lvl_1">
		    <td class="ListColLvl1_name" colspan="2"><h4><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Notification options<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_t($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></h4></td>
		</tr>
	    <?php if ($this->_tpl_vars['o'] == 'mc'): ?>
		<tr class="list_two">
...
<?php echo $this->_tpl_vars['time_unit']; ?>
 ...
 <?php echo $this->_tpl_vars['time_unit']; ?>
        ...
        <tr class="list_two">
        <?php endif; ?>
            <td class="FormRowField"><img class="helpTooltip" name="recovery_notification_delay"> <?php echo $this->_tpl_vars['form']['host_recovery_notification_delay']['label']; ?>
</td>
            <td class="FormRowValue"><?php echo $this->_tpl_vars['form']['host_recovery_notification_delay']['html']; ?>
 <?php echo $this->_tpl_vars['time_unit']; ?>
</td>
    	</tr>
	</table>
...
<table class="formTable table">
    ...
    <tr class="list_two"><td class="FormRowField"><img class="helpTooltip" name="host_acknowledgement_timeout"> <?php echo $this->_tpl_vars['form']['host_acknowledgement_timeout']['label']; ?>
</td><td class="FormRowValue"><?php echo $this->_tpl_vars['form']['host_acknowledgement_timeout']['html']; ?>
&nbsp;<?php echo $this->_tpl_vars['time_unit']; ?>
</td></tr>
    <tr class="list_lvl_1">
        <td class="ListColLvl1_name" colspan="2">
	...
	<tr class="list_one"><td class="FormRowField"><img class="helpTooltip" name="check_freshness"> <?php echo $this->_tpl_vars['form']['host_check_freshness']['label']; ?>
</td><td class="FormRowValue"><?php echo $this->_tpl_vars['form']['host_check_freshness']['html']; ?>
</td></tr>
	<tr class="list_two"><td class="FormRowField"><img class="helpTooltip" name="freshness_threshold"> <?php echo $this->_tpl_vars['form']['host_freshness_threshold']['label']; ?>
...
&nbsp;<?php echo $this->_tpl_vars['seconds']; ?>
	...
	<tr class="list_one"><td class="FormRowField"><img class="helpTooltip" name="flap_detection_enabled"> <?php echo $this->_tpl_vars['form']['host_flap_detection_enabled']['label']; ?>
</td><td class="FormRowValue"><?php echo $this->_tpl_vars['form']['host_flap_detection_enabled']['html']; ?>
</td></tr>
	<tr class="list_two"><td class="FormRowField"><img class="helpTooltip" name="low_flap_threshold"> <?php echo $this->_tpl_vars['form']['host_low_flap_threshold']['label']; ?>
</td><td class="FormRowValue"><?php echo $this->_tpl_vars['form']['host_low_flap_threshold']['html']; ?>
&nbsp;%</td></tr>
	<tr class="list_one"><td class="FormRowField"><img class="helpTooltip" name="high_flap_threshold"> <?php echo $this->_tpl_vars['form']['host_high_flap_threshold']['label']; ?>
...
&nbsp;%</td></tr>
	...
	<tr class="list_one"><td class="FormRowField"><img class="helpTooltip" name="retain_status_information"> <?php echo $this->_tpl_vars['form']['host_retain_status_information']['label']; ?>
</td><td class="FormRowValue"><?php echo $this->_tpl_vars['form']['host_retain_status_information']['html']; ?>
</td></tr>
	<tr class="list_two"><td class="FormRowField"><img class="helpTooltip" name="retain_nonstatus_information"> <?php echo $this->_tpl_vars['form']['host_retain_nonstatus_information']['label']; ?>
</td><td class="FormRowValue"><?php echo $this->_tpl_vars['form']['host_retain_nonstatus_information']['html']; ?>
</td></tr>
	<tr class="list_one"><td class="FormRowField"><img class="helpTooltip" name="stalking_options"> <?php echo $this->_tpl_vars['form']['host_stalOpts']['label']; ?>
	...
	<tr class="list_two"><td class="FormRowField"><img class="helpTooltip" name="event_handler_enabled"> <?php echo $this->_tpl_vars['form']['host_event_handler_enabled']['label']; ?>
	...
	<tr class="list_two"><td class="FormRowField"><img class="helpTooltip" name="event_handler_args"> <?php echo $this->_tpl_vars['form']['command_command_id_arg2']['label']; ?>
...
&nbsp;&nbsp;<img id='ehi_statusmap_image_img' src='./img/blank.gif'></td></tr>
		<?php if ($this->_tpl_vars['form']['geo_coords']['label']): ?>
		<tr class="list_two"><td class="FormRowField"><img class="helpTooltip" name="geo_coords"> <?php echo $this->_tpl_vars['form']['geo_coords']['label']; ?>
</td><td class="FormRowValue"><?php echo $this->_tpl_vars['form']['geo_coords']['html']; ?>
</td></tr>
		<tr class="list_one"><td class="FormRowField"><img class="helpTooltip" name="2d_coords"> <?php echo $this->_tpl_vars['form']['ehi_2d_coords']['label']; ?>
</td><td class="FormRowValue"><?php echo $this->_tpl_vars['form']['ehi_2d_coords']['html']; ?>
</td></tr>
		<tr class="list_two"><td class="FormRowField"><img class="helpTooltip" name="3d_coords"> <?php echo $this->_tpl_vars['form']['ehi_3d_coords']['label']; ?>
</td><td class="FormRowValue"><?php echo $this->_tpl_vars['form']['ehi_3d_coords']['html']; ?>
</td></tr>
		<tr class="list_one"><td class="FormRowField"><img class="helpTooltip" name="criticality_id"> <?php echo $this->_tpl_vars['form']['criticality_id']['label']; ?>
...
<?php endif; ?><?php echo '
        ...
        '; ?>
<?php if ($this->_tpl_vars['form']['frozen'] == true): ?><?php echo '
